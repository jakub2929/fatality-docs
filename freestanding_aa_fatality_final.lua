-- Freestanding Anti-Aim for CS2 using Fatality API (Final Version)
...
local function init()
    ...
    local notify = gui.notification("Freestanding AA Loaded", "Adapted for Fatality API - Final Version", nil)
    gui.notify:add(notify)
    
    print("Freestanding Anti-Aim loaded for Fatality API (Final Version)")
    print("Features:")
